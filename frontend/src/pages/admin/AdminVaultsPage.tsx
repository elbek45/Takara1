          ...
          {vaults.map((vault: any) => (
            ...
            >
              ...
              <div className="space-y-2 mb-4 text-sm">
                ...
                <div className="bg-gradient-to-r from-gold-500/10 to-green-500/10 rounded px-2 py-2 border border-gold-500/20">
                  <div className="text-gray-400 text-xs mb-1">Total Return:</div>
                  <div className="flex justify-between items-center">
                    <div className="text-center">
                      <span className="text-xs text-gray-500">Base</span>
                      <div className="text-sm font-medium text-gray-300">{(vault.baseAPY * vault.duration / 12).toFixed(1)}%</div>
                    </div>
                    <span className="text-gray-500">→</span>
                    <div className="text-center">
                      <span className="text-xs text-gold-400">Max</span>
                      <div className="text-sm font-bold text-gold-400">{(vault.maxAPY * vault.duration / 12).toFixed(1)}%</div>
                    </div>
                  </div>
                </div>
                <div className="flex justify-between">
